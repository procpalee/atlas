  ...
  return (
    <>
      ...
      <div className="flex items-center gap-1 border-t border-zinc-200 px-2.5 py-2 dark:border-zinc-800">
        <NavLink to="/guide" title="사용 설명서" className={({ isActive }) => `rounded-md p-1.5 ${isActive ? 'bg-zinc-200 text-zinc-800 dark:bg-zinc-800 dark:text-zinc-100' : 'text-zinc-500 hover:bg-zinc-200 hover:text-zinc-800 dark:text-zinc-400 dark:hover:bg-zinc-800 dark:hover:text-zinc-100'}`}>
          <HelpCircle size={15.5} strokeWidth={1.9} />
        </NavLink>
        <NavLink to="/settings" title="설정" className={({ isActive }) => `rounded-md p-1.5 ${isActive ? 'bg-zinc-200 text-zinc-800 dark:bg-zinc-800 dark:text-zinc-100' : 'text-zinc-500 hover:bg-zinc-200 hover:text-zinc-800 dark:text-zinc-400 dark:hover:bg-zinc-800 dark:hover:text-zinc-100'}`}>
